...
public class Config {
    ...
    //smartshop finals
    public static List<String> SS_subCommands = List.of("info", "accept", "decline", "remove", "generate", "log", "save", "reload", "search");
    public static List<String> SS_aliases = List.of("smartShop", "ss", "s", "SmartShop");
    public static String SS_MainCommand = "SmartShop";
